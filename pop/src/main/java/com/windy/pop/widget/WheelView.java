...
//        this.mSelectorDrawable = getContext().getResources().getDrawable(R.color.transparent);
...
//        mSelectorBound.set(0, top, getWidth(), bottom);
//        mSelectorBound.set(l, top, r, bottom);
    }
